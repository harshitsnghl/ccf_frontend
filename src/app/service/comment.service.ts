...
export class CommentService {
  ...
  unlikeComment(commentId: number): Observable<any | HttpErrorResponse> {
    return this.httpClient.post<any | HttpErrorResponse>(
      `${this.host}/posts/comments/${commentId}/unlike`,
      null
    );
  }
  ...
  deleteComment(
    ...
    return this.httpClient.post<any | HttpErrorResponse>(
      `${this.host}/posts/${postId}/comments/${commentId}/delete`,
      null
    );
  }
  ...
  getCommentLikes(
    ...
    return this.httpClient.get<User[] | HttpErrorResponse>(
      `${this.host}/posts/comments/${commentId}/likes`,
      { params: reqParams }
    );
  }
  updateComment(
    ...
    return this.httpClient.post<CommentResponse | HttpErrorResponse>(
      `${this.host}/posts/${postId}/comments/${commentId}/update`,
      formData
    );
  }
}
