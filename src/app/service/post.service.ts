...
export class PostService {
  ...
  createNewPost(
    ...
    postPhoto: File,
    postTags: any[]
  ): Observable<Post | HttpErrorResponse> {
    const formData = new FormData();
    formData.append('content', content);
    formData.append('postPhoto', postPhoto);
    formData.append('postTags', JSON.stringify(postTags));
    return this.httpClient.post<Post | HttpErrorResponse>(
      `${this.host}/posts/create`,
      formData
    );
  }
  ...
  deletePostPhoto(postId: number): Observable<any | HttpErrorResponse> {
    return this.httpClient.post<any | HttpErrorResponse>(
      `${this.host}/posts/${postId}/photo/delete`,
      null
    );
  }
  ...
  deletePost(
    ...
    if (isTypeShare) {
      return this.httpClient.post<any | HttpErrorResponse>(
        `${this.host}/posts/${postId}/share/delete`,
        null
      );
    } else {
      return this.httpClient.post<any | HttpErrorResponse>(
  ...
  getPostComments(
    ...
    const reqParams = new HttpParams().set('page', page).set('size', size);
    return this.httpClient.get<CommentResponse[] | HttpErrorResponse>(
      `${this.host}/posts/${postId}/comments`,
      { params: reqParams }
    );
  }
  ...
  createPostComment(
    ...
    return this.httpClient.post<CommentResponse | HttpErrorResponse>(
      `${this.host}/posts/${postId}/comments/create`,
      formData
    );
  }
  ...
  likePostComment(commentId: number): Observable<any | HttpErrorResponse> {
    return this.httpClient.post<any | HttpErrorResponse>(
      `${this.host}/posts/comments/${commentId}/like`,
      null
    );
  }
  ...
  createPostShare(
    ...
    formData.append('content', content);
    return this.httpClient.post<Post | HttpErrorResponse>(
      `${this.host}/posts/${postId}/share/create`,
      formData
    );
  }
